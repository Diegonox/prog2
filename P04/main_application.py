'''
Main application for P04, displays different graphs for the data from the canton Zürich 
about the building land prices. Diego did the Downloader class and MainApplication class
...
class MainApplication():
    ...
    def statistical_moments(self,df):
        ...
        print('Standard deviation:', grouped_by_year['INDIKATOR_VALUE'].std())
        print('Skewness:', grouped_by_year['INDIKATOR_VALUE'].skew())
        print('Kurtosis:', grouped_by_year['INDIKATOR_VALUE'].apply(pd.DataFrame.kurt))
    ...
    def comparison(self,df):
        ...
        compare_df = df.loc[df['GEBIET_NAME'] == 'Zürich']
